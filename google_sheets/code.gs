...
const spreadSheetId = "1Zjje-nRtiA4rhLN0PivUzeGq0u_rG7hiwXWoxQpd5jM";
var ss = SpreadsheetApp.openById(spreadSheetId);

function doGet(e) {
  const read = e.parameter.read;
  if (read !== undefined) {
    return ContentService.createTextOutput('{"name":"'+sheetName+'","list":' + exportJSON(ss)+ '}');
  }
}
